...
@Component({
    selector: 'templateeleven',
    template: require('./templateeleven.component.html'),
    styles: [require('./templateeleven.component.css')],

})

export class TemplateelevenComponent implements OnInit{
