...
@Component({
    selector: 'my-temponedup',
    template: require('./templateonedup.component.html'),
    styles: [require('./templateonedup.component.css')],
    animations:[
      trigger('flyInOut',[
        transition('void=>*',[
...
export class TemplatedupComponent implements OnInit{
