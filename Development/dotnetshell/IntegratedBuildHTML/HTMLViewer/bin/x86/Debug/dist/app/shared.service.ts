...
},
{
    "startAt": 20,
    "segmentId": 198,
    "file": "http://localhost:8080/content00_1/"
},
{
    "startAt": 22,
    "segmentId": 196,
    "file": "http://localhost:8080/content00_2/"
}
...
templateRouterArray:any = [
	...
	['/home/tempfour', '/home/tempfour', 0],
	['/home/tempfive', '/home/tempfive', 0],
	['/home/tempsix', '/home/tempsix', 0],
	['/home/tempeleven', '/home/template11dup', 0],
  ['/home/templatetwoAct', '/home/templatetwoActdup', 0]
...
updateBA(inda) {
  ...
  switch(datar.type) {
    ...
    case "4":
      ...
      this.router.navigate([ this.templateRouterArray[8][this.templateRouterArray[8][2]]]);
      this.updateBA(8);
      break;
      ...
      this.router.navigate([ this.templateRouterArray[9][this.templateRouterArray[9][2]]]);
      this.updateBA(9);
      break;
      ...
      this.router.navigate([ this.templateRouterArray[10][this.templateRouterArray[10][2]]]);
      this.updateBA(10);
      break;
      ...
      this.router.navigate([ this.templateRouterArray[11][this.templateRouterArray[11][2]]]);
      this.updateBA(11);
      break;
      ...
      case "12":
       this.navigatetoroute = datar;
 	     this.navShow=0;
       //this.router.navigate(['/home/template7']);
       this.router.navigate([ this.templateRouterArray[12][this.templateRouterArray[12][2]]]);
       this.updateBA(12);
       break;
  }
