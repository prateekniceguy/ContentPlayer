...
@Component({
    selector: 'tempeightdup',
    template: require('./templateeightdup.component.html'),
    styles: [require('./templateeightdup.component.css')]

})

export class TemplateeightdupComponent implements OnInit{
