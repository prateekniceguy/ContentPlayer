...
@Component({
    selector: 'my-tempsevendup',
    template: require('./template7dup.component.html'),
    styles: [require('./template7dup.component.css')]

})

export class Template7dupComponent implements OnInit{
      ...
      disableNextButtonSwitch = this._sharedService.devEnvironment.disableNextButton;
      ////////////////////////////////////////////////////////////////////////
