...
@Component({
    selector: 'my-twentythirdthree',
    template: require('./twentythirdthree.component.html'),
    styles: [require('./twentythirdthree.component.css')]

})

export class TwentythirdthreeComponent implements OnInit{
      ...
      clicked0(event) {
         ...
         if(this.myoption_duplicate[0].next == true && this._sharedService.autoplay_var){
