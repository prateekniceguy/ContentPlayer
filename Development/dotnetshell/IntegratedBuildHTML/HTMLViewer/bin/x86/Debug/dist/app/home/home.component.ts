...
directives : [ListComponent,PlayComponent,LoadComponent,Load1Component,TemplatesixComponent,TemplatefourComponent,TemplateelevenComponent,Template11dupComponent,TemplatefiveComponent,Template7Component,Template7dupComponent,Load2Component,TemplatethreeComponent,TemplatethreedupComponent,TemplatenineComponent,TemplateninedupComponent,ActivitydupComponent,ActivityComponent,AboutComponent,TemplatetwoComponent,TemplatetwodupComponent,TemplatedupComponent,TemplateoneComponent,TemplatetwoActComponent,
  TemplatetwoActdupComponent]
...
export class HomeComponent implements OnInit  {
 ...
 constructor(private route: ActivatedRoute, private _sharedService: SharedService) {
    ...
    toggleCheck(){
    if(this._sharedService.autoplay_var==1){
    ...
    this._sharedService.autoplay_var=1;
	  ...
	  this._sharedService.doAutoplayIfNeed();
    console.log('Data sent',this._sharedService.autoplay_var);
    }
  }
    sendValueshome(): void {
    ...
    this.flag=1;
      ...
      this._sharedService.playerEventChange();
      }
        }
    ngOnInit() {
