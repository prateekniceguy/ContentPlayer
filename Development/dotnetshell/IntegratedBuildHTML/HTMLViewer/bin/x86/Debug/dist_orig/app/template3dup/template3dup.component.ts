...
@Component({
    selector: 'my-tempthreedup',
    template: require('./template3dup.component.html'),
    styles: [require('./template3dup.component.css')]

})

export class TemplatethreedupComponent implements OnInit{
