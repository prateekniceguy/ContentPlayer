...
@Component({
    selector: 'my-twentythirdfour',
    template: require('./twentythirdfour.component.html'),
    styles: [require('./twentythirdfour.component.css')]

})

export class TwentythirdfourComponent implements OnInit{
