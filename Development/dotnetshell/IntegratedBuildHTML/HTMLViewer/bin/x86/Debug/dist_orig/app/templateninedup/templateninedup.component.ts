...
@Component({
    selector: 'tempninedup',
    template: require('./templateninedup.component.html'),
    styles: [require('./templateninedup.component.css')]

})

export class TemplateninedupComponent implements OnInit{
...
//    }
		...
		bool: boolean = true;
         selected(option) {
			...
			modalImg.src=option.imgsrc_modal;
